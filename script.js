...
function run() {
	...
	let phdrs = ["Search something!", "Type anything here to search!", "This is a cool search engine", "am i cool?", "INFO", "Gurpreet Stinks", "HMM", "Check Out my Website: https://hubcenter.omedqarshi.repl.co/", "yes ik Omed is the best", "I am cooler than you!", "I OMED IS THE BEST!"]
	setInterval(() => {
...
//			<input data-value="web" type="radio" id="radio-one" name="switch-one" value="yes" checked/>
			//<label for="radio-one">The web</label>